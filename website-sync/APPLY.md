# Website agent — ship DataLund Gantt **1.7.1.0** (branded only)
...
| File | `ganttChart.pbiviz` **1.7.1.0** | `GanttChart.pbiviz` |
| Link on site | `/downloads/ganttChart.pbiviz` | **Do not add** |
| Direct release | https://github.com/Datalundno/GANTT/releases/download/v1.7.1.0/ganttChart.pbiviz | https://github.com/Datalundno/GANTT/releases/download/whitelabel-1.7.1.0/GanttChart.pbiviz |
...
git commit -m "Ship DataLund Gantt 1.7.1.0 (time window from today)"
