...
- [ ] Use packaged file: `dist/ganttChart…1.9.2.0.pbiviz` (also copied to `downloads/ganttChart.pbiviz`)
...
- [ ] Do **not** change GUID on updates; bump four-part version (e.g. `1.9.1.0` → `1.9.2.0`)
